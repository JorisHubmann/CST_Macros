...
Sub Main ()
	...
	AName="SDL_8x2_interleaved" 'Change for Result Data Name
...
Sub Optimizer(Nports)
	...
	With DSOptimizer
		...
		For i=1 To 7
		.SelectParameter("Coup" & i & i+1,True)
		.SetParameterInit(0.264791)
		.SetParameterMin(0)
		.SetParameterMax(1)
		Next
		.SelectParameter("Coup81",True)
		.SetParameterInit(0.264791)
		.SetParameterMin(0)
		.SetParameterMax(1)
		...
		.SelectParameter("Coup169",True)
		.SetParameterInit(0.264791)
		.SetParameterMin(0)
		.SetParameterMax(1)

		For i=1 To 8
		.SelectParameter("Coup" & i & i+8,True)
		.SetParameterInit(0.229077)
		.SetParameterMin(0)
		.SetParameterMax(1)
		Next

		For i=2 To 8
		.SelectParameter("Coup" & i & i+7,True)
		.SetParameterInit(0.229077)
		.SetParameterMin(0)
		.SetParameterMax(1)
		Next

		.SelectParameter("Coup116",True)
		.SetParameterInit(0.229077)
		.SetParameterMin(0)
		.SetParameterMax(1)
'define a goal on the S-Parameters
		...
		For i=1 To 7
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & i+1 & "," & i)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
		...
		Next
			...
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & 8 & "," & 1)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
		...
		Next
			...
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & 16 & "," & 9)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
		...
		For i=1 To 8
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & i+8 & "," & i)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
		...
		For i=2 To 8
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & i+7 & "," & i)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
		...
		Next
			...
			gid = .AddGoal("1DC Primary Result")
			.SelectGoal(gid, True)
			.SetGoal1DCResultName("Opt\SPar\S-Parameters\S" & 16 & "," & 1)
			.SetGoalScalarType("magdB20")
			.SetGoalOperator("<")
			.SetGoalTarget(-20)
			.SetGoalRangeType("single")
