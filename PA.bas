...
Sub Main ()
	...
	AName="PA_Duke_Di" 'Change for Result Data Name
	...
	SubV= Array(-250,250,-134,134,-300,90) ' Volume for Export H and E field as well as any other field for CP
	SubVSAR= Array(-250,250,-134,134,-300,90) ' Volume for SAR Export


	'Functions
	Call createModes(Nports,Phase,Amp)
	Call createModesVOP(Nports)
	Call CalcSAR(Nports)
	Call CalcSARVOP(Nports)
